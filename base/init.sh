...
echo ""
echo "This script needs BASH, SED, CURL, LESS and WGET."
echo "BASH for : literally everything from this repo is written in it."
echo "WGET for : getting all the scripts in files."
echo "CURL for : getting more specific parts to be pipeable or be displayed in the terminal."
echo "LESS for : pager used in the main code."
echo "SED for : editing files using regex and it being fast"
echo ""
